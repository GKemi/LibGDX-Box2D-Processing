...
import com.company.hackemi.box2d.*
...
object Sketch : PApplet() {
    ...
    class Box(x: Float, y: Float) {
        ...
        fun makeBody(center: Vector2, w_: Float, h_: Float) {
            ...
            val sd = PolygonShape()
            val box2dW = box2d.scalarPixelsToWorld(w_ / 2)
            val box2dH = box2d.scalarPixelsToWorld(h_ / 2)
            sd.setAsBox(box2dW, box2dH)
            ...
            body.setLinearVelocity(Vector2(random(-5f, 5f), random(2f, 5f)))
